...
uint256 hashGenesisBlock("0x152199b99a48090257f78cb40656bd0f699dcdc231ffdbcfa6b4721a1a489b98");
static const unsigned int timeGenesisBlock = 1389963600;// changedxx
...
static const int64 nTargetTimespan = 120 * 60; // 120 minutes
static const int64 nTargetSpacing = 50; // 30 seconds changedxx
...
//	 unsigned long a = bnNew3.getulong();
	...
	int64 nshare = nGenesisBlockCoin* 999/a;	// Initial share of Marxcoin
    	if ((nshare < nBlockRewardMinimumCoin)||nHeight>86400)
    	{
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "17 Jan 2014, Microsoft Ending Anti-Virus Protection for Windows XP";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nNonce   = 110103262;
        block.nBirthdayA = 2434874;
        block.nBirthdayB = 3184274;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xd1b151628487c257754efde7f7edafc41525a094aa06b0e48f0cf599c58835eb"));
...
unsigned char pchMessageStart[4] = { 0xdd, 0xf9, 0xa5, 0xfe };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MarxcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MarxcoinMiner : ProcessBlock, block not accepted");
    }
